...
const API_KEY= '87c5919f632267cd0453b1835cf8071c'
...
document.getElementById('searchButton').addEventListener('click', () => {
    ...
    if(city){
        fetchWeather(city)
        //Llamar ala API para que nos de la informacion del clima
    }else{
...
function showWeatherData(data){
    ...
    icoInfo.src = `https://openweathermap.org/img/wn/${icon}d@2x.png` //Verificar en la documentacion como mostrar imagen
